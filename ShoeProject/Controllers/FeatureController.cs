...
namespace Shoe.Controllers
{
    public class FeatureController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listFeatures = new List<Models.Feature>();
            foreach (var item in listFeatureDAL)
            {
                listFeatures.Add(_mapper.Map<DAL.Models.Feature, Models.Feature>(item));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var feature = _mapper.Map<DAL.Models.Feature, Models.Feature>(featureDAL);
            return View(feature);
        }
        ...
        public async Task<IActionResult> Create(Models.Feature feature)
        {
            if (ModelState.IsValid)
            {
                var featureDAL = _mapper.Map<Models.Feature, DAL.Models.Feature>(feature);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Models.Feature feature)
        {
            if (id != feature.Id)
            {
                return NotFound();
