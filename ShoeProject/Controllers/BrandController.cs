...
namespace Shoe.Controllers
{
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listBrands = new List<Models.Brand>();
            foreach (var item in listBrandsDAL)
            {
                listBrands.Add(_mapper.Map<DAL.Models.Brand, Models.Brand>(item));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var brand = _mapper.Map<DAL.Models.Brand, Models.Brand>(brandDAL);
            return View(brand);
        }
        ...
        public async Task<IActionResult> Create(Models.Brand brand)
        {
            if (ModelState.IsValid)
            {
                var brandDAL = _mapper.Map<Models.Brand, DAL.Models.Brand>(brand);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Models.Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
