...
namespace Shoe.Controllers
{
    public class SizeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listSizes = new List<Models.Size>();
            foreach (var item in listSizeDAL)
            {
                listSizes.Add(_mapper.Map<DAL.Models.Size, Models.Size>(item));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var size = _mapper.Map<DAL.Models.Size, Models.Size>(sizeDAL);
            return View(size);
        }
        ...
        public async Task<IActionResult> Create(Models.Size size)
        {
            ...
            {
                var sizeDAL = _mapper.Map<Models.Size, DAL.Models.Size>(size);
