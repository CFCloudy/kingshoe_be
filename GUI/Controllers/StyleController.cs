...
namespace Shoe.Controllers
{
    public class StyleController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listStyles = new List<GUI.Models.Style>();
            foreach (var item in listStylesDAL)
            {
                listStyles.Add(_mapper.Map<DAL.Models.Style, GUI.Models.Style>(item));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var style = _mapper.Map<DAL.Models.Style, GUI.Models.Style>(styleDAL);
            return View(style);
        }
        ...
        public async Task<IActionResult> Create(GUI.Models.Style style)
        {
            if (ModelState.IsValid)
            {
                var styleDAL = _mapper.Map<GUI.Models.Style, DAL.Models.Style>(style);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, GUI.Models.Style style)
        {
            if (id != style.Id)
            {
                return NotFound();
