...
namespace Shoe.Controllers
{
    public class ColorController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listColors = new List<GUI.Models.Color>();
            foreach (var item in listColorsDAL)
            {
                listColors.Add(_mapper.Map<DAL.Models.Color, GUI.Models.Color>(item));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var color = _mapper.Map<DAL.Models.Color, GUI.Models.Color>(colorDAL);
        ...
        public async Task<IActionResult> Create(GUI.Models.Color color)
        {
            if (ModelState.IsValid)
            {
                var colorDAL = _mapper.Map<GUI.Models.Color, DAL.Models.Color>(color);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, GUI.Models.Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
